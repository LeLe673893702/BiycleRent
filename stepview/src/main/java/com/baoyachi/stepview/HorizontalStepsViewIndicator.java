...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private int mCompletedLineColor = ContextCompat.getColor(getContext(), R.color.completed_line);//定义默认完成线的颜色      definition mCompletedLineColor
    ...
    private void init()
    {
        ...
        mUnCompletedPaint.setStrokeWidth(5);
        ...
        mLinePadding = 1.7f * defaultStepIndicatorNum;
    ...
    protected synchronized void onDraw(Canvas canvas)
    {
        ...
        for(int i = 0; i < mCircleCenterPointPositionList.size() -1; i++)
        {
            ...
            if(i <= mComplectingPosition&&mStepBeanList.get(i).getState()!=StepBean.STEP_UNDO)//判断在完成之前的所有点
            {
